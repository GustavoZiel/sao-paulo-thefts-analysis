...
void SELECT_WHERE_TREE(){
    ...
    */
    ...
    for(int i = 0; i < num_buscas; i++){
        ...
        /*
        Como o arquivo de índice desevolvido apenas indexa 'idCrime', devemos checar 
        se 'idCrime' é tanto o campo indexado do arquivo de índice fornecido pelo 
        usuário, quanto que o usuário buscou por algum 'idCrime'. Em caso positivo 
        em ambos os casos, realizamos a busca no arquivo de índice, caso contrário,
